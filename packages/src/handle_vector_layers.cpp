...
void HVL::create_vector_layer_observation_point(QString fname, QString layer_name, _location_type * obs_points, long epsg_code, QgsLayerTreeGroup * treeGroup)
{
    if (obs_points != NULL && obs_points->type == OBSERVATION_TYPE::OBS_POINT  || obs_points->type == OBSERVATION_TYPE::OBS_POLYLINE)
    {
        ...
        if (!layer_found)
        {
            ...
            {
                QgsSvgMarkerSymbolLayer * simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "/icons/lateral.svg");
...
void HVL::create_vector_layer_1D_structure(GRID * grid_file, JSON_READER * prop_tree, long epsg_code, QgsLayerTreeGroup * treeGroup)
{
    if (prop_tree != nullptr)
    {
        ...
        if (cnt_bridges > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "/icons/structure_bridge_1d.svg");
        ...
        if (cnt_bridgepillars > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "/icons/structure_bridgepillar_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_compound_structures > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "/icons/structure_compound_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_culverts > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/structure_culvert_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_extra_resistances > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/structure_extra_resistance_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_generalstructures > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/structure_general_structure_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_inverted_siphons > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/structure_inverted_siphon_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_orifices > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/structure_orifice_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_pumps > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/structure_pump_1d.svg");
            simple_marker->setSize(5.0);
        ...
        if (cnt_riverweirs > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "/icons/structure_riverweir_1d.svg");
            simple_marker->setSize(5.0);
            simple_marker->setDataDefinedProperties(QgsPropertyCollection(QString("River weir location")));
        ...
        if (cnt_weirs > 0)
        {
            ...
            QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/structure_weir_1d.svg");
            simple_marker->setSize(5.0);
...
void HVL::create_vector_layer_1D_cross_section(GRID * grid_file, JSON_READER * prop_tree, long epsg_code, QgsLayerTreeGroup * treeGroup)
{
    ...
    else
    {
        ...
        QgsSvgMarkerSymbolLayer * simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/cross_section_location_1d.svg");
        simple_marker->setSize(5.0);
...
void HVL::create_vector_layer_1D_retention(GRID* grid_file, JSON_READER* prop_tree, long epsg_code, QgsLayerTreeGroup* treeGroup)
{
    ...
    else
    {
        ...
        QgsSvgMarkerSymbolLayer* simple_marker = new QgsSvgMarkerSymbolLayer(program_env + "icons/retention_location_1d.svg");
        simple_marker->setSize(5.0);
