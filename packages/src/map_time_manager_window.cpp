...
void MapTimeManagerWindow::closeEvent(QCloseEvent * ce)
{
    ...
    if (m_map_property_window->get_count() != 0)
    {
        m_map_property_window->closeEvent(nullptr);
        delete m_map_property_window;
        m_map_property_window = nullptr;
    }
...
#include "vsi.xpm"
    ...
    icon_iso_patch = get_icon_file(program_env_dir, "/icons/iso_patch.png");
    icon_vectors = get_icon_file(program_env_dir, "/icons/vectors.png");
